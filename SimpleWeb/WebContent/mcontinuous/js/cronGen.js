...
(function ($) {
    ...
    $.fn.extend({
        cronGen: function () {
            ...
            var $g = $("<div>").addClass("input-group form-inline");
            // Add an input
            var $i = $("<input>", { type: 'text', placeholder: 'Cron trigger', readonly: 'readonly' }).addClass("form-control input-sm").val($(that).val());
            $i.appendTo($g);
            // Add the button <span class="input-group-addon">.00</span>
            var $b = $("<span class=\"input-group-btn\"><button class=\"btn btn-sm \" ><i class=\"glyphicon glyphicon-pencil\"></i></button></span>");
